...
[![hexlet-check](https://github.com/MadnessLalka/java-project-71/actions/workflows/hexlet-check.yml/badge.svg)](https://github.com/MadnessLalka/java-project-71/actions)
...
```bash
git clone https://github.com/MadnessLalka/java-project-71.git
cd java-project-71
```
